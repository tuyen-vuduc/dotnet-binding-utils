...
{
    partial interface ISTPFormTextFieldContainer { }

    partial interface ISTPAUBECSDebitFormViewDelegate { }

    partial interface ISTPCardFormViewDelegate { }

    partial interface ISTPPaymentCardTextFieldDelegate { }
  ...
  be used.
*/
	[Protocol (Name = "_TtP16StripePaymentsUI25STPFormTextFieldContainer_"), Model]
	...
	interface STPMultiFormTextField : STPFormTextFieldContainer, IUITextFieldDelegate
	{
	...
	[Protocol (Name = "_TtP16StripePaymentsUI30STPAUBECSDebitFormViewDelegate_"), Model]
	...
	partial interface STPFloatingPlaceholderTextField
	{
	}
	...
	[Protocol (Name = "_TtP16StripePaymentsUI23STPCardFormViewDelegate_"), Model]
	...
	partial interface STPGenericInputPickerField
	{
		// @property (nonatomic, strong) NSAttributedString * _Nullable accessibilityAttributedValue;
		[NullAllowed, Export ("accessibilityAttributedValue", ArgumentSemantic.Strong)]
		NSAttributedString AccessibilityAttributedValue { get; set; }
	...
	partial interface STPGenericInputPickerField : IUIPickerViewDelegate
	{
	...
	[Protocol (Name = "_TtP16StripePaymentsUI31STPPaymentCardTextFieldDelegate_"), Model]
