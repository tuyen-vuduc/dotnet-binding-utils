...
public class FetcherTests
{
    ...
    [InlineData("Xamarin.Android.Arch.Lifecycle.LiveData", "android.arch.lifecycle", "livedata")] 
    [InlineData("Xamarin.Android.Arch.Lifecycle.ViewModel", "android.arch.lifecycle", "viewmodel")] 
    [InlineData("Xamarin.Android.Arch.Lifecycle.Extensions", "android.arch.lifecycle", "extensions")] 
    [InlineData("Xamarin.AndroidX.Arch.Core.Common", "android.arch.core", "common")] 
    [InlineData("Xamarin.AndroidX.Arch.Core.Runtime", "android.arch.core", "runtime")] 
    [InlineData("Xamarin.Android.Arch.Persistence.Db", "android.arch.persistence", "db")] 
    [InlineData("Xamarin.Android.Arch.Persistence.Db.Framework", "android.arch.persistence", "db-framework")] 
    [InlineData("Xamarin.Android.Arch.Persistence.Room.Common", "android.arch.persistence.room", "common")] 
    [InlineData("Xamarin.Android.Arch.Persistence.Room.Runtime", "android.arch.persistence.room", "runtime")] 
    ...
    [InlineData("Org.Jetbrains.Kotlin.KotlinParcelizeRuntime", "org.jetbrains.kotlin", "kotlin-parcelize-runtime")]
