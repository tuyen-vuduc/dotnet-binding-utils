...
namespace Com.Drivesync.Android.Provider.Activity.Mobile
{
    partial class GmsActivityProvider
    {
        ...
        partial class GmsActivityRequest
        {
            public override global::Java.Lang.Object ParseResult(global::Android.Content.Intent intent)
                => ParseResultX(intent);
        }
...
namespace Com.Drivesync.Android.Provider.Activity
{
    partial interface IDsActivityRequest : global::Com.Drivesync.Android.Provider.IGenericProviderRequest
    {

    }

    partial interface IDsActivityProvider : global::Com.Drivesync.Android.Provider.IGenericProvider
    {

    }

    partial class IDsActivityProviderInvoker
    {
