...
#ifndef AMAZONFREERTOS_SWIFT_H
#define AMAZONFREERTOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AmazonFreeRTOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// FreeRTOS device.
SWIFT_CLASS("_TtC14AmazonFreeRTOS20AmazonFreeRTOSDevice")
...
/// FreeRTOS manager.
SWIFT_CLASS("_TtC14AmazonFreeRTOS21AmazonFreeRTOSManager")
...
@interface AmazonFreeRTOSManager (SWIFT_EXTENSION(AmazonFreeRTOS)) <CBPeripheralDelegate>
...
@interface AmazonFreeRTOSManager (SWIFT_EXTENSION(AmazonFreeRTOS)) <CBCentralManagerDelegate>
