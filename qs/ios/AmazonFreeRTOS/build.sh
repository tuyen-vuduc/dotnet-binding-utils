...
# Release dir path
OUTPUT_DIR_PATH="${PROJECT_DIR}/.output/${DYNAMIC_FRAMEWORK}"
...
function createXCFrameworkForStaticLibrary {
  ...
  xcodebuild -create-xcframework \
            ...
            -headers /Volumes/ws/oss/braintree-ios-drop-in/podqs/Pods/BraintreeDropIn/Sources/BraintreeDropIn/Public/${1} \
